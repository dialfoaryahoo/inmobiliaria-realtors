...
public class EstudiantesDB {
    ...
    public static String Campos_Tabla=" identificacion, nombre_completo, fecha_nac, lugar_nac, direccion,edad,estado, fecha_reg, saldo";
    ...
    public static int insertar(){
        ...
        try{
            stmt = Conexion.conexion.prepareStatement
                ...
                stmt.setInt(8, 1);
                stmt.setTimestamp(8, Estudiante.fecha_reg);
    ...
    public static boolean load_ONE(String codigo, int param){
        ...
        try{
            ...
            while(n.next()){
                existe=true;
//                Estudiante est = new Estudiante(n.getInt("id_estudiante"), n.getString("identificacion"), n.getString("nombre_completo"), n.getDate("fecha_nac"), n.getString("lugar_nac"), n.getString("direccion"), n.getInt("edad"), n.getInt(""), param, param)
            }
