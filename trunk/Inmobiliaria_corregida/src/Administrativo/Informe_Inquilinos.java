 ...
 * @author Usuario
 */
public class Informe_Inquilinos extends javax.swing.JDialog {
    ...
    public Informe_Inquilinos(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setSize(1000,750);
//        jLabel10.requestFocus();
        setTitle("INFORME INQUILINOS");
    ...
    public void llenartabla(){
        ...
        modeloDeMiJTable.addColumn("CARTERA");
...
//        String consulta="select codigo, direccion, uso, clase, edificio, barrio, municipio, canon , admon, admon_estado FROM inmuebles where inmueble_disponible = 2";
        String consulta="select inq.cedula, inq.codigo, inq.nombre_completo, inq.fijo, inq.celular, inq.saldo, inq.estado_inquilino from inquilinos as inq ";
...
//    }
    ...
    private void initComponents() {
        ...
        jScrollPane1.setBounds(20, 140, 960, 400);

        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 2, true), "INQUILINOS", javax.swing.border.TitledBorder.RIGHT, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 1, 14), new java.awt.Color(0, 0, 0))); // NOI18N
        ...
        jTextField_total_arr.setBounds(800, 30, 120, 30);

        jLabel15.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel15.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel15.setText("TOTAL INQUILINOS");
        jPanel3.add(jLabel15);
        jLabel15.setBounds(590, 30, 220, 30);
        ...
        jTextField_total_saldo.setBounds(380, 30, 220, 30);

        jLabel16.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel16.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel16.setText("TOTAL CARTERA");
        jPanel3.add(jLabel16);
        jLabel16.setBounds(180, 30, 220, 30);

        getContentPane().add(jPanel3);
        jPanel3.setBounds(20, 550, 960, 90);

        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 2, true), "BUSCAR INQUILINO", javax.swing.border.TitledBorder.RIGHT, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 1, 14), new java.awt.Color(0, 0, 0))); // NOI18N
        ...
        jComboBox_propietario.setBounds(510, 40, 240, 40);
        ...
        jTextField_saldo.setBounds(280, 40, 190, 40);

        jLabel20.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel20.setForeground(new java.awt.Color(0, 0, 204));
        jLabel20.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel20.setText("CARTERA MAYOR A:");
        ...
        jTextField_codigo.setBounds(60, 40, 190, 40);

        getContentPane().add(jPanel1);
        jPanel1.setBounds(20, 10, 960, 110);
